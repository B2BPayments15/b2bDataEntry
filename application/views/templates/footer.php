...
<!-- Bootstrap core JavaScript
   ...
   <!--  <script src="<?php //echo base_url(); ?>js/vendor/popper.js"></script>
    ...
    <script>window.jQuery || document.write('<script src="<?php //echo base_url(); ?>js/vendor/jquery.js"><\/script>')</script>
